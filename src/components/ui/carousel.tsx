    ...
    return (
      <CarouselContext.Provider
        value={{
          ...
          canScrollNext,
          scrollTo,
          hasMultipleSlides: numberOfSlides > 1,
          numberOfSlides,
          currentSlide,
        }}
      >
...
const CarouselPrevious = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<typeof Button> & { hideWithoutMultipleSlides?: boolean }
>(
  (
    {
      className,
    ...
    return (
      <Button
        ...
        className={cn(
          ...
          hideWithoutMultipleSlides && !hasMultipleSlides && "hidden",
          className
        )}
      ...
      >
        ...
        <span className="sr-only">Elément précédent</span>
      </Button>
    );
  }
);
  ...
  (
    ...
    return (
      ...
      >
        ...
        <span className="sr-only">Prochain élément</span>
      </Button>
    );
  }
);
...
const CarouselDots = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => {
  const { scrollTo, hasMultipleSlides, numberOfSlides, currentSlide } =
    useCarousel();
